...
public class ItemReactiveRepositoryTest {
    ...
    public void getAllItems() {
        ...
        StepVerifier.create(itemReactiveRepository.findAll().log("FoundedItems:")) // 4
                .expectSubscription()
                .expectNextCount(5)
                .verifyComplete();
    }
    ...
    public void getItemByID() {
        ...
        StepVerifier.create(itemReactiveRepository.findById("ABC").log("FoundedItems:"))
                .expectSubscription()
    ...
    public void updateItem() {
        ...
        StepVerifier.create(updatedItem.log("FlatMapExecution:"))
                .expectSubscription()
